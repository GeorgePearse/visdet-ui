...
function isAllowedPath(path, rule) {
  return matchesAnyPattern(path, rule.allowedPatterns) && !matchesAnyPattern(path, rule.excludedPatterns);
}
...
module.exports = async ({ github, context, core }) => {
  ...
  // In this repo, allow maintainer-authored PRs to pass without a second approval.
  // GitHub disallows approving your own pull request, so requiring a maintainer approval
  // would otherwise make maintainer-owned PRs impossible to merge.
